...
def import_csv():
    ...
    # Import CSV parsers
    from utils.csv_parsers import auto_detect_and_parse_csv_out_machine, auto_detect_and_parse_csv, parse_mir_csv_file, parse_zkteco_standard_file, parse_hikvision_csv_file, import_attendance_records
